...
func (h *handlerTicket) FindAllTickets(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: http.StatusOK, Data: tickets})
}
...
func (h *handlerTicket) CreateTicket(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: http.StatusOK, Data: ticketResponse})
}
...
func (h *handlerTicket) GetTicket(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: http.StatusOK, Data: ticket})
}
...
func (h *handlerTicket) CreateTransactionQty(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: http.StatusOK, Data: MyTicketQty})
}
